...
- Local UI (`ui`) with left/right artifact prefill, listener start/stop controls, default recording folder controls, filesystem browsing, artifact rename support, and raw selected-step payload inspection (including identical steps).
