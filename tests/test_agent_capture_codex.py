...
def test_cli_agent_capture_codex_fixture_writes_timeline_artifact(tmp_path: Path) -> None:
    out_path = tmp_path / "agent-codex.rpk"
    fixture = Path("tests/fixtures/agents/fake_codex_agent.py")
    runner = CliRunner()
